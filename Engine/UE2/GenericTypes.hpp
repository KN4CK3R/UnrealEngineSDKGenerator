...
class UEPointerProperty : public UEProperty
{
public:
...
template<>
inline bool UEObject::IsA<UEScriptStruct>() const
{
	//UE2 doesn't have ScriptStruct so we need to check a little bit more
	if (IsA<UEStruct>())
	{
...
{
	//UE2 doesn't have an EnumProperty.
